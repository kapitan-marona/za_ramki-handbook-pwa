...
shutil.copy2(backend, backend.with_suffix(".js.bak_micro10_retry"))
shutil.copy2(api, api.with_suffix(".js.bak_micro10_retry"))
...
new_api = '''    return await ZRBackend.taskActivity.log(taskId, type, body, payload);
'''
...
if old_api not in api_text:
    raise SystemExit("Planner API logTaskActivity anchor not found")
...
print("micro10 retry patch applied")
